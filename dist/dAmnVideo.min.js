...
}}k=m.length;if(k==0){return}for(var n=0;n<k;n++){m[n].enabled=true}};j.localmic=[];j.localvideo=[];j.onlocalstream=function(){f[0].src=j.localurl;j.localmic=j.localstream.getAudioTracks();j.localvideo=j.localstream.getVideoTracks()};g.vp=a[0];g.remotemic=[];g.remotevideo=[];g.onremotestream=function(){a[0].src=URL.createObjectURL(g.remote_stream);g.remotemic=g.remote_stream.getAudioTracks();g.remotevideo=g.remote_stream.getVideoTracks()}};dVideo.Phone.prototype.hangup=function(a,b){this.destroy_call(a);if(a.group){return}a.close()};dVideo.Phone.prototype.destroy_call=function(a){if(a!=this.call){return}if(a.localstream){a.localstream.stop()}this.client.bds.peer.remove(a.pns);var b=this.client.ui.chatbook.channel(a.ns);if(b){b.el.m.find("div.phone").remove();b.ulbuf-=250;b.resize()}this.call=null};dVideo.SignalHandler=function(b,a){this.phone=b;this.client=a};dVideo.SignalHandler.prototype.request=function(c){if(dVideo.APPNAME!=c.call.app&&c.call.app_ver>=dVideo.APPVERSION){return}var b=c.call;
var d=c.peer;var a=dVideo.phone;if(this.client.ui.umuted.indexOf(d.user.toLowerCase())!=-1){b.signal.reject(d.user,"You have been blocked");return false}if(this.client.away.on){b.signal.reject(d.user,b.user+" is away; "+client.away.reason);return false}if(a.call!=null){if(a.call!=b||!b.group){b.signal.reject(d.user,"Already in a call");return false}}d.onicecompleted=function(){console.log("> finished ice.")};d.onremotedescription=function(){d.create_answer()};d.onlocaldescription=function(){b.signal.answer(d);dVideo.phone.client.ui.chatbook.channel(b.ns).server_message("Call Started");d.persist()};d.onclose=function(){dVideo.phone.hangup(b,d)};d.onreject=function(e){dVideo.phone.client.ui.chatbook.channel(b.ns).server_message("Call Rejected",e);dVideo.phone.hangup(b,d)};a.incoming(b,d)},dVideo.SignalHandler.prototype.ack=function(a){};dVideo.SignalHandler.prototype.reject=function(a){};dVideo.SignalHandler.prototype.accept=function(b){if(dVideo.APPNAME!=b.call.app){return}var a=b.call;var c=b.peer;
c.onicecompleted=function(){console.log("> finished ice.");if(c.remote_stream!=null){return}var d=c.pc.getRemoteStreams();if(d.length==0){return}c.remote_stream=d[0];c.vp.src=URL.createObjectURL(c.remote_stream)};c.onlocaldescription=function(){a.signal.offer(c)};c.onremotedescription=function(){dVideo.phone.client.ui.chatbook.channel(a.ns).server_message("Call Started");c.persist()};c.onclose=function(){dVideo.phone.hangup(a,c)};c.onreject=function(d){dVideo.phone.client.ui.chatbook.channel(a.ns).server_message("Call Rejected",d);dVideo.phone.hangup(a,c)};c.create_offer()};dVideo.SignalHandler.prototype.open=function(a){};dVideo.SignalHandler.prototype.end=function(a){};dVideo.SignalHandler.prototype.offer=function(c){if(dVideo.APPNAME!=c.call.app){return}var a=c.call;var d=c.peer;var b=c.offer;d.onremotedescription=function(){d.answer()};d.ready(function(){a.signal.answer(d);console.log("> connected to new peer",d.user)},b)};dVideo.SignalHandler.prototype.answer=function(b){if(dVideo.APPNAME!=b.call.app){return
