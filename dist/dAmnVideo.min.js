...
var d=c.peer;var a=dVideo.phone;if(this.client.ui.umuted.indexOf(d.user.toLowerCase())!=-1){b.signal.reject(d.user,"You have been blocked");return false}if(this.client.away.on){b.signal.reject(d.user,"Away; "+client.away.reason);return false}if(a.call!=null){if(a.call!=b||!b.group){b.signal.reject(d.user,"Already in a call");return false}}d.onicecompleted=function(){console.log("> finished ice.")};d.onremotedescription=function(){d.create_answer()};d.onlocaldescription=function(){b.signal.answer(d);dVideo.phone.client.ui.chatbook.channel(b.ns).server_message("Call Started");d.persist()};d.onclose=function(){dVideo.phone.hangup(b,d)};a.incoming(b,d)},dVideo.SignalHandler.prototype.ack=function(a){};dVideo.SignalHandler.prototype.reject=function(a){};dVideo.SignalHandler.prototype.accept=function(b){if(dVideo.APPNAME!=b.call.app){return}var a=b.call;var c=b.peer;c.onicecompleted=function(){console.log("> finished ice.");if(c.remote_stream!=null){return}var d=c.pc.getRemoteStreams();if(d.length==0){return
}c.remote_stream=d[0];c.vp.src=URL.createObjectURL(c.remote_stream)};c.onlocaldescription=function(){a.signal.offer(c)};c.onremotedescription=function(){dVideo.phone.client.ui.chatbook.channel(a.ns).server_message("Call Started");c.persist()};c.onclose=function(){dVideo.phone.hangup(a,c)};c.create_offer()};dVideo.SignalHandler.prototype.open=function(a){};dVideo.SignalHandler.prototype.end=function(a){};dVideo.SignalHandler.prototype.offer=function(c){if(dVideo.APPNAME!=c.call.app){return}var a=c.call;var d=c.peer;var b=c.offer;d.onremotedescription=function(){d.answer()};d.ready(function(){a.signal.answer(d);console.log("> connected to new peer",d.user)},b)};dVideo.SignalHandler.prototype.answer=function(b){if(dVideo.APPNAME!=b.call.app){return}var a=b.call;var c=b.peer;var c=a.peer(c.user);if(!c){return}c.open(function(){console.log("> connected to new peer ",c.user)},b.answer)};dVideo.SignalHandler.prototype.candidate=function(d){var c=phone.call;var g=d.param[0];var a=d.param[1];var f=d.param[2];
console.log(d.param.slice(3));var b=new dVideo.RTC.SessionDescription(JSON.parse(d.param.slice(3).join(",")));if(f.toLowerCase()!=client.settings.username.toLowerCase()){return}var e=c.peer(a);if(!e){return}e.conn.candidate(b)};dVideo.SignalHandler.prototype.close=function(a){};